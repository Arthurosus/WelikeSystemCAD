"""
Modelos relacionados à entidade Empresa e seus agregados.
"""
...
class RedeSocial(Base):
    ...
    id         = Column(Integer, primary_key=True, index=True)
    tipo       = Column(String(50), nullable=False)   # e-mail / instagram / …
...
class Endereco(Base):
    ...
    id          = Column(Integer, primary_key=True, index=True)
    formato     = Column(String(20), nullable=False, default="brasil")
